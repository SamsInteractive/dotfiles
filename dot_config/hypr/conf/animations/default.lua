...
hl.animation({ leaf = "specialWorkspaceIn", enabled = true, speed = 5, bezier = "overshot", style = "slide bottom" })
hl.animation({ leaf = "specialWorkspaceOut", enabled = true, speed = 5, bezier = "overshot", style = "slide top" })
